---
doc_id: ac.doc.ckg.dead-code-quality-hardening-plan
...
- backend/packages/agentcore_cli/commands/quality_audit/collect.py::build_quality_audit_report
related_docs:
...
- AgentCore never deletes repository files.
...
- `backend/packages/agentcore_cli/commands/quality_audit/collect.py` (hint text if needed)
...
- [x] Restart AgentCore MCP; run live probe for real
