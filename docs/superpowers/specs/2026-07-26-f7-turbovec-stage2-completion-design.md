---
doc_id: ac.doc.stack.f7-turbovec-stage2-completion-design
...
| --- | --- | --- | --- |
| 1 | Operator | Set `AGENTCORE_RAG_ANN_ACCELERATOR=turbovec` | Accelerator enabled at process start |
...
- `AGENTCORE_TURBOVEC_SYNC_MODE=async_job` worker drain.
