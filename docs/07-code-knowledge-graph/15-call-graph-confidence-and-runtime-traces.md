---
doc_id: ac.doc.ckg.call-graph-confidence
...
related_docs:
- ac.doc.ckg.language-support-policy
...
Define how AgentCore labels CALL-edge evidence, caps or boosts confidence, decides impact eligibility, and reconciles runtime-observed CALLS with static analysis (GAP-T02). Wrong high-confidence CALLS poison blast-radius tools; this standard keeps confidence honest.
