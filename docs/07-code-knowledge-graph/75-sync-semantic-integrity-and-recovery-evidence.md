---
doc_id: ac.doc.ckg.sync-semantic-integrity-evidence
...
|---|---|---|
| `.agentcore/sync-usage/2026-07-28_21-41-25.json` | Failed | Document phase no longer showed connection exhaustion, but `38` files failed on legacy `version=null` |
| `.agentcore/sync-usage/2026-07-28_21-57-28.json` | Succeeded | Recovery queue processed `39 / 39`; `files_failed=0`; document errors empty |
| `.agentcore/sync-usage/2026-07-28_22-19-02.json` | Succeeded | Final changed-file queue processed `1 / 1`; semantic refresh scanned `8,979`, skipped `8,979`, refreshed `0`; freshness `ok` |
