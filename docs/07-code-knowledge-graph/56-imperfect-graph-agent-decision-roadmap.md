---
doc_id: ac.doc.ckg.imperfect-graph-agent-decision-roadmap
...
- ac.doc.ckg.evidence-hop-planner
- ac.doc.ckg.edge-evidence-envelope
- ac.doc.ckg.freshness-eligibility-policy
- ac.doc.ckg.code-graph-fault-bench
- ac.doc.ckg.uncertainty-aware-code-plan
- ac.doc.ckg.evidence-route-policy
- ac.doc.ckg.gap-diagnosis-pipeline
