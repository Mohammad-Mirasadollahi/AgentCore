...
| **Cache** | `<AGENTCORE_DATA_ROOT>/cache/docs-catalog.json` (default sibling `<install>-data`; override `AGENTCORE_DOCS_CATALOG_CACHE`; roots via `AGENTCORE_DOCS_CATALOG_ROOTS` or `--roots`) |
