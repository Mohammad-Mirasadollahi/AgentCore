---
doc_id: ac.doc.sea.test-fixture-catalog
title: 51 - Test Fixture Catalog
doc_type: standard
status: active
schema_version: '1.0'
owner: platform-engineering
summary: 'Normative AgentCore test fixture strategy: catalog metadata (owner, scope,
...
- ac.doc.sea.testing-seams-and-contract-boundary-standards
language: en
...
Define how AgentCore shares, classifies, and validates **test fixtures** so graph,
