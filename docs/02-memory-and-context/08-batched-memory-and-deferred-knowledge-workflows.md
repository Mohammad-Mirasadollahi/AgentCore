---
doc_id: ac.doc.memory.batched-memory-and-deferred-knowledge-workflows
title: 08 - Batched Memory And Deferred Knowledge Workflows
doc_type: standard
status: active
schema_version: '1.0'
owner: platform-docs
summary: AgentCore must avoid creating long-term memory, documentation updates, review tasks,
