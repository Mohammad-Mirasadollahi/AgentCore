...
def main() -> int:
    ...
    os.environ["AGENTCORE_ADAPTER_SERVICE_DATABASE_URL"] = os.environ.get(
        "AGENTCORE_ADAPTER_SERVICE_DATABASE_URL"
    ) or "postgresql://agentcore:agentcore-local-dev-secret@127.0.0.1:32232/agentcore"
