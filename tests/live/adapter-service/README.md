...
Verify the shipped Adapter Service composition against the main AgentCore PostgreSQL infrastructure, plus an optional vendor sandbox.
...
| Linear | `AGENTCORE_LINEAR_API_KEY`, `AGENTCORE_LINEAR_TEAM_ID`, and for status push `AGENTCORE_LINEAR_DONE_STATE_ID` |
...
The main-infrastructure wrapper loads the normal repository environment and points Adapter Service at the same PostgreSQL database used by AgentCore. It does not start substitute infrastructure.
