...
def check_phase_gate(
    *,
    ...
    """Evaluate the Phase 9 platform governance and operations exit gate."""
    ...
    try:
        ...
        checks.append(
            CheckResult(
                "phase9-governance-catalogs-valid",
                "governance_catalog",
                "governance",
                "failed",
