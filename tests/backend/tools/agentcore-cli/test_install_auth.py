...
from agentcore_auth import verify_registered_access_token
from agentcore_auth.token_registry import InMemoryAccessTokenRegistry
from agentcore_auth.tokens import mint_and_register_access_token
from agentcore_cli.install_auth import (
...
def test_mint_install_api_key_registers_and_writes_once_file(tmp_path: Path, monkeypatch):
    ...
    assert mint["access_token"].startswith("ac1.")
