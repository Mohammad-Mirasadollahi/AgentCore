...
import pytest
from agentcore_auth.token_registry import InMemoryAccessTokenRegistry, hash_access_token
from agentcore_auth.tokens import mint_and_register_access_token, verify_registered_access_token
...
def test_hash_access_token_is_sha256_hex() -> None:
    raw = "ac1.example-payload.signature"
...
def test_in_memory_registry_never_stores_raw_token() -> None:
    raw_token = "ac1.super-secret-payload-should-never-be-stored.sig-value"
