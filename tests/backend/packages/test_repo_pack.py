...
def test_layered_ignore_gitignore_and_agentcoreignore(tmp_path: Path):
...
def test_review_pack_respects_agentcoreignore(tmp_path: Path):
    (tmp_path / ".agentcoreignore").write_text("secret.env\n", encoding="utf-8")
