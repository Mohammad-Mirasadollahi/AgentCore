#!/usr/bin/env python3
"""CLI entry for Phase 11 CheckPhaseGate."""
...
from phase11.checks import run_all_checks  # noqa: E402
from phase11.gate import check_phase_gate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run AgentCore Phase 11 verification gate")
    ...
    if args.json:
        ...
        print(f"Phase 11 gate: {gate['status']} ({gate['passed_count']} passed, {gate['failed_count']} failed)")
