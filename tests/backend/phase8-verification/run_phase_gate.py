#!/usr/bin/env python3
"""CLI entry for Phase 8 CheckPhaseGate."""
...
from phase8.checks import run_all_checks  # noqa: E402
from phase8.gate import check_phase_gate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run AgentCore Phase 8 verification gate")
    ...
    if args.json:
        ...
        print(f"Phase 8 gate: {gate['status']} ({gate['passed_count']} passed, {gate['failed_count']} failed)")
