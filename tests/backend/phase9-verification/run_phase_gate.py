#!/usr/bin/env python3
"""CLI entry for Phase 9 CheckPhaseGate."""
...
from phase9.checks import run_all_checks  # noqa: E402
from phase9.gate import check_phase_gate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run AgentCore Phase 9 verification gate")
    ...
    if args.json:
        ...
        print(f"Phase 9 gate: {gate['status']} ({gate['passed_count']} passed, {gate['failed_count']} failed)")
