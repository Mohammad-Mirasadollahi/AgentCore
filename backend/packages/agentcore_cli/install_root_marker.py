...
Role: stamp the absolute AgentCore checkout path after install/first run for
...
paths; treating unvalidated paths as AgentCore roots; requiring root to read
markers.
"""
    ...
    for target in targets:
        ...
        try:
            ...
            try:
                ...
                pass
            # Tree .agentcore should be traversable by non-root readers.
