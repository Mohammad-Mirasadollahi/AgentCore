"""One-shot copy from legacy Compose named volumes into AgentCore-data bind dirs."""
...
# compose.yaml ``name: agentcore`` + volume key → docker volume name
LEGACY_VOLUME_MAP: tuple[tuple[str, str], ...] = (
    ("agentcore_agentcore-postgres-data", "postgres"),
    ("agentcore_agentcore-neo4j-data", "neo4j"),
)
