"""Ingest use cases: file indexing, edge writing, and unresolved-call relink."""
...
from ..domain.models import GraphSymbol, IngestResult, RepoIngestFileOutcome, RepoIngestResult, Scope
...
class IngestUseCases(GraphServiceSupport):
    def ingest_file(
        self,
        scope: Scope,
        actor_id: str,
