...
13. **Fix-on-read (module contracts):** After Read of a **hard** module (Hard Module Test = yes) with a missing/wrong contract header, load `agentcore-source-contracts` and fix the 3–6 line header **in the same turn**. Do not stamp helpers/DTOs/re-exports or write “just in case.”
