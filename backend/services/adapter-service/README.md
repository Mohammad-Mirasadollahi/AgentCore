...
- Outbox consumer: `outbox_relay.handlers.TicketDispatchHandler` (`AGENTCORE_OUTBOX_TICKET_DISPATCH_HANDLER`)
...
The canonical PostgreSQL live test uses the same service composition and main AgentCore database:
