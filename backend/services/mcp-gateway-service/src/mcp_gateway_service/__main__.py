...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--ssl-certfile",
        default=os.environ.get("AGENTCORE_MCP_TLS_CERTFILE", ""),
        help="TLS certificate PEM (HTTPS). Env: AGENTCORE_MCP_TLS_CERTFILE",
    )
    parser.add_argument(
        "--ssl-keyfile",
        default=os.environ.get("AGENTCORE_MCP_TLS_KEYFILE", ""),
        help="TLS private key PEM (HTTPS). Env: AGENTCORE_MCP_TLS_KEYFILE",
    )
