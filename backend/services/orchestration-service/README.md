...
Owns agent routing, workflow coordination, and work batches.
...
Vertical slice implemented. Canonical tests live under `tests/backend/services/orchestration-service/`.
